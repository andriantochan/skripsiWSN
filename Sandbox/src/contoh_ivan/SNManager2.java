...
// Sensor1
	private static final String sensorId = "Sensor2";
			...
			public void run() {
				...
				while (true) {
					try {
						...
						System.out.println("Hi i received your msg!! \n your msg is : " + str);
						send("Thank You", SENSOR_NODE_ADDRESS, previousNode[0], fio);
					} catch (IOException e) {
					} 
				}
			}

...
public class GraphAmplitude extends JPanel {
	...
	public GraphAmplitude(String sensorId) {
		...
		range.setRange(1.0,2.0);
		domain.setTickLabelsVisible(true);

		range.setStandardTickUnits(NumberAxis.createIntegerTickUnits());

		chart = new JFreeChart("Visualizing Amplitude " + sensorId, new Font("SansSerif", Font.BOLD, 24), plot, true);
	...
	public void showPlot() {
		if (!showed) {
			this.showed = true;
			frame = new JFrame("Visualizing Amplitude " + sensorId);
			GraphAmplitude panel = this;
